        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
                ...
                <DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                context.Roles.AddRange(
                    ...
                    //new IdentityRole { Id = "2c5e174e-3b0e-446f-86af-483d56fd7211", Name = "Userneinregistrat", NormalizedName = "Userneinregistrat".ToUpper() },
                ...
                context.Users.AddRange(
                    ...
                    /*ew ApplicationUser
                    {
                        ...
                        UserName = "userneinregistrat@test.com",
                        EmailConfirmed = true,
                        NormalizedEmail = "USERNEINREGISTRAT@TEST.COM",
                        Email = "userneinregistrat@test.com",
                        NormalizedUserName = "USERNEINREGISTRAT@TEST.COM",
                        PasswordHash = hasher.HashPassword(null, "Userneinregistrat1!")
                    },*/
                    new ApplicationUser
                    {
